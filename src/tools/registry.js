    ...
    inputSchema: {
      ...
      properties: {
        ...
        workers: {
          type: 'number',
          description:
            'Number of parallel workers. Defaults to Playwright config value. session_run_test forces workers:1.',
        },
        signalAttach: {
          type: 'boolean',
          description:
            'Wait for fixture to confirm CDP attach before running tests. Default: false.',
        },
        keepOpen: {
          type: 'boolean',
          description:
        ...
        reportFile: {
          type: 'string',
          description:
            'Repo-relative JSON report path. Default: sessions/<sessionName>/last-run.json. Returns resolved path',
        },
      },
      required: ['sessionName'],
    },
      ...
      properties: {
        session: {
          ...
          properties: {
            ...
            templateConflict: {
              ...
              default: 'fail',
              description:
                '"clone-from-live" is experimental: Chrome file handles may cause partial profile copy; use "close-first" for consistency',
            },
            launchOptions: {
              type: 'object',
              properties: {
        ...
        postPolicy: {
          ...
          properties: {
            action: {
              type: 'string',
              enum: ['destroy', 'keep', 'save'],
              description: 'Default: "destroy" for clone, "save" for template',
            },
