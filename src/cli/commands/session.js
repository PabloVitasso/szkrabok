...
export function register(program, { safe }) {
    ...
    safe(async () => {
      ...
      console.table(
        sessions.map(s => ({
          ...
          Template:
            s.templateSession !== null && s.templateSession !== undefined
              ? s.templateSession
              : 'N/A',
  ...
  session.command('inspect <id>').action(
    safe(async id => {
  ...
  session.command('delete <id>').action(
    safe(async id => {
          ...
          entries
            ...
            .map(async e => {
              ...
              if (
                ...
                meta !== undefined &&
                meta.lastUsed !== null &&
                meta.lastUsed !== undefined &&
                meta.lastUsed < cutoff
              ) {
